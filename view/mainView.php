            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                        <a class="nav-link ' . ($page == 'insertProduct' ? 'active' : '') . '" aria-current="page" href="#">Cadastrar Produto</a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link ' . ($page == 'products' ? 'active' : '') . '" aria-current="page" href="#">Produtos</a>
                        </li>
